const QNA = [
  ...
  {
    question: "야근을 하고 퇴근길에 힘들일이 있다는 친구가 술마시자 하면?",
    answers: [
      {
      ...
      {
        text: "늦게까진 못마셔😅 적당히 얘기를 듣고 집으로 간다.",
        score: 7,
      },
      {
        text: "미안하다말하고 곧장 집으로 간다.",
        score: 2,
      },
    ],
  },
  {
    ...
    answers: [
      {
        text: "역할을 잘 배분하고 팀원을 다독여 잘 마무리한다.",
        score: 9,
      },
      {
  ...
  {
    question: "길에서 전단지를 나눠주던 사람이 전단지를 건넨다면?",
    answers: [
      {
        text: "대꾸도 하지 않는다.",
        score: 10,
      ...
      {
        text: "괜찮다고 하고 가던길을 간다.",
        score: 5,
      },
      {
        text: "거절을 못하겠다. 어차피 버릴거지만 일단 받는다.",
        score: 3,
      },
    ],
  },
